...
export default function LoginRightContent() {
  ...
  return (
    <div className="w-full md:w-[500px] xl:w-[530px] p-8 flex flex-col justify-center items-center rounded-r-lg relative overflow-hidden mb-10 mt-16 md:mt-0 md:mb-0">
      {/* Foreground Content */}
